...
QA_SUITES = [
    ...
    {"suite_file": "27_hyper_advanced_isolation.sh", "title": "Hyper-Advanced Isolation, OCI Compiler & Sandbox Fabric", "assertions": 42, "proof_class": "L2_SYSTEM", "release_blocker": True}
]
