...
QA_SUITES = [
    {"suite_file": "01_syntax_and_static_analysis.sh", "title": "Syntax & Static Analysis", "assertions": 15},
    {"suite_file": "02_cli_argument_and_fuzzing.sh", "title": "CLI Argument Parsing & Fuzzing", "assertions": 34},
    {"suite_file": "03_unit_internal_functions.sh", "title": "Unit Tests for Internal Functions", "assertions": 25},
    {"suite_file": "04_storage_and_diet_resilience.sh", "title": "Storage Subsystem & Diet Resilience", "assertions": 23},
    {"suite_file": "05_ephemeral_sandbox_isolation.sh", "title": "Ephemeral Sandbox & Isolation", "assertions": 11},
    {"suite_file": "06_fault_injection_and_chaos.sh", "title": "Fault Injection & Chaos Resilience", "assertions": 12},
    {"suite_file": "07_flake_and_hermetic_reproducibility.sh", "title": "Flake & Hermetic Reproducibility", "assertions": 10},
    {"suite_file": "08_env_poisoning_and_isolation.sh", "title": "Environment Poisoning & Variable Sanitization", "assertions": 30},
    {"suite_file": "09_boundary_buffer_and_property_fuzzing.sh", "title": "Boundary, Buffer & Property-Based Fuzzing", "assertions": 50},
    {"suite_file": "10_filesystem_invariants_and_symlink_defense.sh", "title": "Filesystem Invariants & Symlink Defense", "assertions": 22},
    {"suite_file": "11_concurrency_race_conditions.sh", "title": "Concurrency & Race Conditions", "assertions": 18},
    {"suite_file": "12_resource_exhaustion_ulimit.sh", "title": "Resource Exhaustion & POSIX ulimit Stress", "assertions": 20},
    {"suite_file": "13_mutation_and_negative_invariants.sh", "title": "Mutation & Negative Invariants", "assertions": 13},
    {"suite_file": "14_mcp_jsonrpc_protocol.sh", "title": "MCP JSON-RPC Protocol", "assertions": 31},
    {"suite_file": "15_shadow_vm_simulation.sh", "title": "Shadow Micro-VM Simulation", "assertions": 30},
    {"suite_file": "16_distro_standalone_architecture.sh", "title": "Distro Standalone Architecture", "assertions": 30},
    {"suite_file": "17_distro_kernel_and_subsystem_invariants.sh", "title": "Distro Kernel & Subsystem Invariants", "assertions": 35},
    {"suite_file": "18_distro_dev_stacks_and_fuzzing.sh", "title": "Distro Dev Stacks & Fuzzing", "assertions": 35},
    {"suite_file": "19_distro_adr_and_architecture_contracts.sh", "title": "Distro ADR & Architecture Contracts", "assertions": 35},
    {"suite_file": "20_distro_storage_and_btrfs_resilience.sh", "title": "Distro Storage & Btrfs Resilience", "assertions": 35},
    {"suite_file": "21_opencode_service_and_autoupdate.sh", "title": "OpenCode AI Copilot & Autonomous Updates", "assertions": 25},
    {"suite_file": "22_update_system_and_desktop_notifier.sh", "title": "Autonomous Update Policy & Desktop Notifier", "assertions": 30},
    {"suite_file": "23_endeavouros_parity_and_onboarding.sh", "title": "EndeavourOS Parity, Onboarding & Distro Polish", "assertions": 30},
    {"suite_file": "24_system_manual_and_ai_reference.sh", "title": "System Manual & Native AI Reference Verification", "assertions": 44}
]
