...
assert_output_contains "env -i $TARGET_BIN version" "0.2.0-alpha" "Stripped env retains version metadata"
...
assert_output_contains "LC_ALL='C' $TARGET_BIN version" "0.2.0-alpha" "LC_ALL=C preserves output integrity"
