...
assert_output_contains "env -i $TARGET_BIN version" "$CANONICAL_VERSION" "Stripped env retains version metadata"
...
assert_output_contains "LC_ALL='C' $TARGET_BIN version" "$CANONICAL_VERSION" "LC_ALL=C preserves output integrity"
