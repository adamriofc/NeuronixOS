...
assert_output_contains "grep -F 'Konteks & Masalah' '${DOCS_PATH}/adr/ADR-001-why-flakes.md'" "Konteks" "ADR-001 has context section"
assert_output_contains "grep -F 'Keputusan Arsitektur' '${DOCS_PATH}/adr/ADR-001-why-flakes.md'" "Keputusan" "ADR-001 has decision section"
assert_output_contains "grep -F 'Konsekuensi' '${DOCS_PATH}/adr/ADR-001-why-flakes.md'" "Konsekuensi" "ADR-001 has consequences section"
...
assert_output_contains "grep -F 'Konteks & Masalah' '${DOCS_PATH}/adr/ADR-002-why-calamares-flake-generator.md'" "Konteks" "ADR-002 has context section"
assert_output_contains "grep -F 'Konsekuensi' '${DOCS_PATH}/adr/ADR-002-why-calamares-flake-generator.md'" "Konsekuensi" "ADR-002 has consequences section"
...
assert_output_contains "grep -F 'Konsekuensi' '${DOCS_PATH}/adr/ADR-003-immutable-store-vs-flatpak.md'" "Konsekuensi" "ADR-003 has consequences section"
...
assert_output_contains "grep -F 'TIDAK PERNAH mem-fork' '${DOCS_PATH}/adr/ADR-004-update-channel-strategy.md'" "mem-fork" "ADR-004 strictly prohibits fork"
...
assert_output_contains "grep -F 'Persyaratan Sistem' '${DOCS_PATH}/installation.md'" "Persyaratan" "Installation guide specifies requirements"
assert_output_contains "grep -F 'Btrfs ZSTD:3' '${DOCS_PATH}/installation.md'" "Btrfs" "Installation guide specifies Btrfs ZSTD"
assert_output_contains "grep -F 'Calamares Installer' '${DOCS_PATH}/installation.md'" "Calamares" "Installation guide outlines Calamares workflow"
