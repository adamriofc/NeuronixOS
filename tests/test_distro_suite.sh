...
assert_contains "${DISTRO_ROOT}/installer/calamares/modules/users.conf" "defaultUser: \"neuronix\"" "Calamares users module sets default user"
assert_contains "${DISTRO_ROOT}/installer/calamares/modules/users.conf" "autologinGroup: \"wheel\"" "Calamares users module declares autologinGroup"
