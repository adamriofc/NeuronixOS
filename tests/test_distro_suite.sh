...
check_file "${DISTRO_ROOT}/installer/calamares/modules/users.conf"
check_file "${DISTRO_ROOT}/installer/calamares/modules/welcome.conf"
check_file "${DISTRO_ROOT}/installer/calamares/modules/locale.conf"
check_file "${DISTRO_ROOT}/installer/calamares/modules/keyboard.conf"
...
assert_contains "${DISTRO_ROOT}/installer/calamares/settings.conf" "dont-chroot: false" "Calamares password jobs operate in the installed target"
...
assert_contains "${DISTRO_ROOT}/installer/calamares/modules/users.conf" "doAutologin: false" "Calamares preserves authenticated installed login"
assert_contains "${DISTRO_ROOT}/installer/calamares/modules/shellprocess-neuronix.conf" 'TARGET_USER=${USER}' "Calamares forwards the chosen user to the engine"
assert_contains "${DISTRO_ROOT}/installer/calamares/modules/mount.conf" "extraMounts" "Calamares mount module declares extraMounts"
