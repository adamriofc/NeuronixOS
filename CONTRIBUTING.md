...
NEURONIX maintains an automated test taxonomy comprising 987 assertions across 24 QA master suites, 19 distro component suites, and 12 standalone verification gates (cataloged in `data/test_manifest.json`). All tests must pass with a 100% success rate before pull requests can be merged.

Run the test suite locally:

```bash
# Run the master test runner (643 tests across 24 suites)
...
# Generate and verify canonical test manifest (987 tests total)
