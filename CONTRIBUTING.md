...
NEURONIX maintains an automated test taxonomy comprising 1,111 assertions across 27 QA master suites, 19 distro component suites, and 14 standalone verification gates (cataloged in `data/test_manifest.json`). All tests must pass with a 100% success rate before pull requests can be merged.

Run the test suite locally:

```bash
# Run the master test runner (746 tests across 27 suites)
...
# Generate and verify canonical test manifest (1,111 tests total)
