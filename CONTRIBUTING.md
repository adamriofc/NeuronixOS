...
NEURONIX maintains an automated test taxonomy comprising 1,179 assertions across 29 QA master suites, 19 distro component suites, and 14 standalone verification gates (cataloged in `data/test_manifest.json`). All tests must pass with a 100% success rate before pull requests can be merged.

Run the test suite locally:

```bash
# Run the master test runner (814 tests across 29 suites)
...
# Generate and verify canonical test manifest (1,179 tests total)
