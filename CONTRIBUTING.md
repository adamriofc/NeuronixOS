...
NEURONIX maintains an automated test taxonomy comprising 1,129 assertions across 27 QA master suites, 19 distro component suites, and 14 standalone verification gates (cataloged in `data/test_manifest.json`). All tests must pass with a 100% success rate before pull requests can be merged.

Run the test suite locally:

```bash
# Run the master test runner (764 tests across 27 suites)
...
# Generate and verify canonical test manifest (1,129 tests total)
