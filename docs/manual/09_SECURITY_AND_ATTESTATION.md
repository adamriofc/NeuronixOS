...
1. **Deterministic SPDX 2.3 SBOM:**  
   The build pipeline generates an official Software Bill of Materials in SPDX 2.3 JSON specification (`dist/neuronix-os-v1.0.5-sbom.spdx.json`), inventorying every upstream package, license, and derivation hash.
