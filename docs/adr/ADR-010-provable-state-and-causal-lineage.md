...
3. **Deterministic Attestation:** System health is proven in real time by recomputing the StateRoot against active TPM2 PCR 7/11 measurements, Nix store derivations, and the 1,229-assertion assurance taxonomy.
